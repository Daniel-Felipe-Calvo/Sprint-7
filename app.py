...
if hist_button: # al hacer clic en el botón
    ...
    fig = px.histogram(car_data, x="odometer", labels={"odometer": "Millas Recorridas"})
...
if scatter_checkbox:  # al marcar la casilla
    ...
    fig_scatter = px.scatter(car_data, x="odometer", y="price", title="Precio vs. Odómetro", labels={"odometer": "Millas Recorridas", "price": "Precio ($)"})
